...
export default function Favorites(props) {
    ...
    if(!restaurants) return <Loading isVisible text="Cargando restaurantes..." />
    ...
    return (
        <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
            ...
            <Text style={{ fontSize: 20, fontWeight: "bold", textAlign: "center" }}>
                Necesitas estar logueado para ver estas opciones
            </Text>
            <Button
                title="Ir al login"
                containerStyle={{ marginTop: 20, width: "80%" }}
                buttonStyle={{ backgroundColor: "#00a680" }}
                // TODO: SOLUCION A PROBLEMA NAVIGATE
...
function Restaurant({ restaurant, setIsLoading, toastRef, setReloadData, navigation }) {
    ...
    const confirmRemoveFavorite = () => {
        Alert.alert(
            ...
            "¿Estas seguro de que quieres eliminar restaurante de favoritos?",
            [
                {
                    text: "Cancelar",
                    style: "cancel"
    ...
    return (
        <View style={styles.restaurant}>
            {/* TODO: problema ruta y con parametro solucionado navigation v5 */}
            <TouchableOpacity onPress={() => navigation.navigate("restaurants", {
                ...
                <Image
                    ...
                    source={images[0] ? { uri: images[0] } : "../../assets/img/no-image.png"}
                />
